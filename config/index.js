export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx66816387eb547154",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1ba7c1c749637050690bb339de7570e5",
   ...
   */
  USERS: ["o9qsy52TGiWg-rVw_4zLLqW-Z5cI","o9qsy52oirUrWfIbK1OelvQOJGQg"]
    {
      // 想要发送的人的名字
      name: "最可爱的女朋友！",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "B8IbrgdeC6sRkkyGz1oPcOtZLTqb1mpL8bGn9tYVJRs",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "隆化",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "最最最可爱的女朋友", "year": "1998", "date": "12-23"},
      ],
